...
import com.trucdulieu.orderservice.event.Producer;
import com.trucdulieu.orderservice.model.dto.OrderDto;
import com.trucdulieu.orderservice.model.dto.OrderItemDto;
import com.trucdulieu.orderservice.model.dto.ProductStockResponseDto;
import com.trucdulieu.orderservice.model.entity.Order;
import com.trucdulieu.orderservice.model.entity.OrderItem;
import com.trucdulieu.orderservice.repository.OrderRepository;
...
public class OrderServiceImpl implements OrderService{
    ...
    public void createOrder(OrderDto orderDto) {
        ...
        ProductStockResponseDto productStockResponseDto  = loadBalancedWebClientBuilder.build().get()
                .uri("http://product-stock-service/api/product-stocks", // load from eureka
