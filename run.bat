...
cd ../../order-service/target && start java -jar order-service-0.0.1-SNAPSHOT.jar
cd ../../product-stock-service/target && start java -jar product-stock-service-0.0.1-SNAPSHOT.jar
cd ../../
